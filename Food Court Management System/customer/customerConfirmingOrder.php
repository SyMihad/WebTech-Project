 <html>
    <title>Customer Confirming Order</title>
    <body>
...
$old_order_serial=(int)trim(fgets($file));
...
if($selected_rows_count==0 || $total_bill==0) {header('location:customerChoosingFoodItems.php?err=none_selected');}
