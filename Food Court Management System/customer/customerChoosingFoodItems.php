                   ...
                   <?php
                        ...
                        else if(isset($_GET['err']))
                        {
                            if($_GET['err'] == 'none_selected'){
                                echo '<tr><td align="center"><p  style="color:red; font-size:20px;"><b> You Must Select The Food Items Properly To Proceed!<b></p></td></tr>';  
                            }
                    ...
                    <tr>
                     ...
                     <li><a href="logOut.php">LogOut</a></li>
                        ...
                        <td align="center">
                        <form method="post" action="customerConfirmingOrder.php" enctype="">
                        ...
                        if (filesize('allFoods/'.$restaurantName.'/allFoodNames.txt') == 0){
                            // "The file is empty";

                            header('location: customerChoosingRestaurant.php?err=food_menu_file_empty');
                        }
                        ...
                        while(!feof($file))
                        {
                            ...
                            if(isset($record_elements[0]) && isset($record_elements[1]))
                            {
                                ...
                                echo "<tr><td align='center' > <input type='radio' name='foodName".$i."' value='".$foodName."'  ></td> "; 
                                 ...
                                 echo "<td align='center'><input type='number' name='selected_quantity".$i."' value='0' min='1' style='width:50px'></td></tr>";
